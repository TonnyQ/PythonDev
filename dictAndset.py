...
print("dic has Tonny. key : ","Tonny" in dic)
print("dic has Tonny. Key2: ",dic.get("Tonny",-1)) #返回None时python交互命令下不显示结果

#dict删除一个key-value
dic.pop("Adm")
print("pop adm key : ",dic)
...
s = set([1,2,4]
#print(s) #set显示顺序不一定与出入参数顺序一致

#ass = set([1,2,1,1,2,1,4])
#print(ass) #重复元素将被set自动过滤
